...
from vnxCliApi.lib.common import daemon, check_int, check_text
from vnxCliApi.vnx.cli import CliClient, raise_if_err
from vnxCliApi.vnx.enums import \
    VNXProvisionEnum, VNXTieringEnum, VNXSPEnum, VNXPortType, VNXError, \
    has_error, VNXMigrationRate, VNXMirrorViewSyncRate, \
    VNXMirrorViewRecoveryPolicy, VNXLunType
...
class VNXLunList(VNXCliResourceList):
    ...
    def _get_raw_resource(self):
        return self._cli.get_lun(lun_type=self._lun_type)
...
class VNXLun(VNXResource):
    ...
    @staticmethod
    def get(cli, lun_id=None, name=None, lun_type=None):
