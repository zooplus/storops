...
from vnxCliApi.exception import VNXLockRequiredException, VNXBackendError, \
    VNXObjectNotFound, VNXInvalidMoverID
from vnxCliApi.lib import xmlapi
from vnxCliApi.lib.common import Enum, check_int
from vnxCliApi.lib.converter import to_int, to_hex
from vnxCliApi.lib.xmlapi import XMLAPIParser
from vnxCliApi.vnx.enums import has_error, VNXError
from vnxCliApi.vnx.nas_cmd import NasCommand
from vnxCliApi.vnx.resource.cifs_share import CifsAccessControl
from vnxCliApi.vnx.xml import NasXmlBuilder
...
class VNXNasConnections(object):
    ...
    def xml_parser(self):
        if self._xml_parser is None:
            self._xml_parser = xmlapi.XMLAPIParser()
