...
class CliClientTest(TestCase):
    ...
    def test_create_lun_no_lun(self):
        ...
        assert_that(f, raises(ValueError, 'lun_id or lun_name'))
    ...
    def test_remove_pool_lun_value_error(self):
        assert_that(calling(self.client.remove_pool_lun),
                    raises(ValueError, 'lun_id or lun_name'))
    ...
    def test_create_mount_point_missing_primary_lun(self):
        ...
        assert_that(f, raises(ValueError, 'should be supplied'))
...
class NodeHeartBeatTest(TestCase):
    ...
    def test_normal(self):
        ...
        hb.add('spa', '1.1.1.1')
        hb.add('spb', '1.1.1.2')
        assert_that(hb.is_available('spa'), none())
        assert_that(hb.is_available('spb'), none())
        time.sleep(0.5)
    ...
    def test_get_alive_sp_ip_down(self):
        ...
        assert_that(f, raises(VNXSystemDownError, 'not available'))
    ...
    def test_update_by_ip_latency(self):
        ...
        time.sleep(0.3)
        node = hb.nodes[0]
        assert_that(node.latency, greater_than(0))
